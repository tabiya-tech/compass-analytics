...
def enable_debugger(port: int):
    ...
    :return:
    """
    pulumi.info("Starting the pulumi stack with the remote debugger")
...
def _authenticate_gcloud():
    ...
    - Otherwise, assume the CI/CD environment (GitHub) has already authenticated externally
      (e.g. via Workload Identity Federation).
    """
