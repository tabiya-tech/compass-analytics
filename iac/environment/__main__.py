...
from create_environment import create_new_environment
...
def main():
    ...
    realm_reference = pulumi.StackReference(f"tabiya-tech/analytics-realm/{realm_name}")
    ...
    #   b) to ensure that the frontend URL is available for the frontend iac project
